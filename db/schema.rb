...
ActiveRecord::Schema.define(:version => 20120430124920) do
  ...
  create_table "content_about_us", :force => true do |t|
    t.string   "title"
    t.text     "body"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  create_table "content_intro_us", :force => true do |t|
    t.string   "title"
    t.text     "body"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  create_table "content_mini_intro_us", :force => true do |t|
    t.string   "title"
    t.text     "body"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  create_table "function_room_schemas", :force => true do |t|
    t.datetime "created_at",          :null => false
    t.datetime "updated_at",          :null => false
    t.string   "schema_file_name"
    t.string   "schema_content_type"
    t.integer  "schema_file_size"
  ...
  create_table "reservation_recipes", :force => true do |t|
    t.integer  "reservation_id"
    t.integer  "recipe_id"
    t.datetime "created_at",     :null => false
    t.datetime "updated_at",     :null => false
